...
<div class="container">
    ...
    ?> 
      ...
      <div class="logo-container">
        <img src="http://127.0.0.1:5500/imagenes/pastilleroVirtualrecortado.jpeg" alt="Logo" />
    ...
    <div class="row">
        ...
        <div class="profile-image">
            <img src="http://127.0.0.1:5500/imagenes/paciente2.png" alt="Paciente" />
            <a href='10-perfilpaciente.php' class="btn waves-effect waves-light">Paciente</a>
        </div>
        <div class="profile-image">
            <img src="http://127.0.0.1:5500/imagenes/cuidador2.png" alt="Cuidador" />
            <a href="http://127.0.0.1:5500/html/12-perfilcuidador.html" class="btn waves-effect waves-light">Cuidador</a>
        </div>
    </div>
</div>

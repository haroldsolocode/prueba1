...
if ($result_validacion->num_rows > 0) {
    ...
    echo "<meta http-equiv='refresh' content='5;url=http://127.0.0.1:5500/html/8-Registro.html'>"; // Redirige después de 5 segundos;
} else {
    ...
    if ($ins) {
        ...
        echo "<meta http-equiv='refresh' content='5;url=http://localhost/PASTI/php/1-index.php'>"; // Redirige después de 5 segundos
    } else {
        ...
        echo "<meta http-equiv='refresh' content='5;url=http://127.0.0.1:5500/html/8-Registro.html'>";
    }
}
?>
